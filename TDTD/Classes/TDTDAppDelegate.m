...
#import "TDTDAppDelegate.h"
#import "TDTDViewController.h"

@implementation TDTDAppDelegate
...
{    
	...
	if ([[UIScreen screens] count] > 1)
	{
		...
		colorTrackingViewController = [[TDTDViewController alloc] initWithScreen:externalScreen];
	...
	{
		colorTrackingViewController = [[TDTDViewController alloc] initWithScreen:[UIScreen mainScreen]];
		[window addSubview:colorTrackingViewController.view];
	}
