...
@implementation TDTDViewController
...
- (void)loadView 
{
	...
	glView = [[TDTDGLView alloc] initWithFrame:CGRectMake(0.0f, 0.0f, applicationFrame.size.width, applicationFrame.size.height)];	
...
#pragma mark -
#pragma mark TDTDCameraDelegate methods
